  ...
  return (
    <Accordion
      ...
      itemClasses={{
        ...
        heading: `rounded-lg transition-all ${isDark
    ...
    >
      <AccordionItem
        ...
        aria-label={title}
        title={
          <div className="flex items-center gap-2.5 pl-2.5"> {/* Match SidebarItem padding */}
            {icon}
            <span
      ...
      >
        <div className="flex flex-col gap-1 pl-12 pt-2"> {/* Adjusted padding for sub-items */}
