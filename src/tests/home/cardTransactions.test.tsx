...
describe('CardTransactions', () => {
    ...
    it('should render the profile images for each transaction', () => {
        ...
        transactions.forEach((_, index) => {
            ...
            expect(img.src).toContain(`https://i.pravatar.cc/48?u=a042581f4e29026024d&img=${index}`);
        });
    });
    ...
    it('should apply the correct classes for dark mode', () => {
        ...
        transactions.forEach(transaction => {
            ...
            expect(screen.getByText(transaction.amount)).toHaveClass('text-green-400');
    ...
    it('should apply the correct classes for light mode', () => {
        ...
        transactions.forEach(transaction => {
            ...
            expect(screen.getByText(transaction.amount)).toHaveClass('text-green-600');
            expect(screen.getByText(transaction.date)).toHaveClass('text-default-500');
        });
    });
});
